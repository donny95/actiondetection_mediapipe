...
def draw_styled_landmarks(image, results):
    ...
    mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_holistic.POSE_CONNECTIONS,
                              mp_drawing.DrawingSpec(color=(80, 22, 10), thickness=2, circle_radius=5),
...
DATA_PATH = os.path.join(path, 'MP_test')


# Actions that we try to detect
actions = np.array(['hush2'])
...
print("--------  Collect Keypoint values for Training and Testing !!! ------------- ")
        ...
        for sequence in range(no_sequences):
            ...
            for frame_num in range(sequence_length):
                ...
                if frame_num == 0:
                    ...
                    cv2.putText(image, 'Collecting frames for {} Video Number {} ing....{}'.format(action, sequence,frame_num), (15, 12),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1, cv2.LINE_AA)
